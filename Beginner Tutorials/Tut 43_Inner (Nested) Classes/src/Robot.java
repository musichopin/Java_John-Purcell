public class Robot {
    ...
    // non-static inner classes are used when we need to group some functionality.
    private class Brain { 
    	// nested class privated olabilir
    	// normal class private da statik de olamaz
        public void think() {
    ...
    public static class Battery {
        public void charge() {
            ...
            // statik class'da olduðu için doðudan "id" denemez
        }
    }
    ...
    public void start() {
        ...
        brain.think();
        // think metodu statikmiþ gibi instance yaratýlýr
